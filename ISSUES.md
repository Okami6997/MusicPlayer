...
| 7 | `app` | Samsung/media output notification visibility may be inconsistent when other media players are active | Verified improvement in v0.0.3 using Media3 notification provider and startup foreground notification |
